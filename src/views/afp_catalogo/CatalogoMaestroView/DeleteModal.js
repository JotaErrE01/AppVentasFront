...
const DeleteModal = ({ catalogo, className, onClose, open, onDelete, loading, ...rest }) => {
	...
	return (
		<Dialog maxWidth="sm" fullWidth onClose={onClose} open={open} aria-labelledby="delete-catalogo-maestro-modal">
			<DialogTitle id="delete-catalogo-maestro-modal" onClose={onClose}>
