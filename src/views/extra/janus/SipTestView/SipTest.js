...
function SipTest({
  ...
  const [userNumberCall, setUserNumberCall] = useState(phone)
  ...
  return (
    <div>
      ...
      <Box id="phone_call" className={classes.viewSection}>
        ...
        <Container maxWidth="xs" className={classes.bodySection}>
          ...
          <div hidden={!userRegistered}>
            ...
            <Box className={classes.phoneNumber}>
              ...
              <TextField
                style={{ display: 'none' }}
                width="30%"
                label="Número a llamar"
                margin="normal"
                name="numberCall"
                id="numberCall"
                type="text"
                variant="outlined"
                value={userNumberCall}
              />
            </Box>
          ...
          <div id="participans" hidden={!userRegistered}>
            <div className={classes.marcarRow}>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('1')} className={classes.button}> 1</IconButton>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('2')} className={classes.button}> 2</IconButton>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('3')} className={classes.button}> 3</IconButton>
            </div>
            <div className={classes.marcarRow}>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('4')} className={classes.button}> 4</IconButton>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('5')} className={classes.button}> 5</IconButton>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('6')} className={classes.button}> 6</IconButton>
            </div>
            <div className={classes.marcarRow}>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('7')} className={classes.button}> 7</IconButton>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('8')} className={classes.button}>8</IconButton>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('9')} className={classes.button}> 9</IconButton>
            </div>

            <div className={classes.marcarRow}>
              <IconButton disabled={userCalling || !userTalking || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('*')} className={classes.button}>*</IconButton>
              <IconButton disabled={userCalling || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('0')} className={classes.button}>0</IconButton>
              <IconButton disabled={userCalling || !userTalking || (userTalking && !toggleAudio)} color="secondary" size="large" type="button" variant="contained" onClick={() => clickKeyBoard('#')} className={classes.button}>#</IconButton>
            </div>
            ...
            <div className={classes.marcarRow}>
              ...
              {
                !(userCalling || userTalking || userNumberCall.length == 0) ?

                  <IconButton
                    disabled={userCalling || userTalking || userNumberCall.length == 0}
                    color="secondary"
                    size="large"
                    type="button"
                    variant="contained"
        ...
        <Box className={classes.controlsSection}>
          <Controls settingsCb={setToggleAside} />
        </Box>
      </Box>
