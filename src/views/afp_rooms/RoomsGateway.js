...
function RoomsGateway({
    ...
    const [remoteC, setRemoteC] = useState(0);
    ...
    function setAudioOutput(index, valueAudioOut) {
        ...
        if (current.refStream.current.srcObject !== null) {
            ...
            {/* <div id="videos" hidden={!viewVideos} /> */}
                ...
                <div hidden={!pluginVRReady}>
                    ...
                    <Button // registrar
                        ...
                        type="button"
                        variant="contained"
                        onClick={() => registerUsername(streamLocal.nameUserJoin)}
                    >
